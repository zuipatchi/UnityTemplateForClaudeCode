...
description: Unityゲームの機能設計書を作成するための詳細ガイドとテンプレート。機能設計書作成時にのみ使用。
allowed-tools: Read, Write
---

# Unity ゲーム 機能設計書作成スキル

このスキルは、Unityゲームの高品質な機能設計書を作成するための詳細ガイドです。
...
機能設計書は、PRDで定義された「何を作るか」を「どう実現するか」に落とし込みます。
